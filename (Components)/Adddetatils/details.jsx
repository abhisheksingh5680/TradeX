    ...
    const ContractSection = ({ available }) => (
        <div className="space-y-2">
            ...
            {available ? (
                ...
                <div className="space-y-2">
                    <div className="text-gray-700">Not available</div>
            ...
            case 0:
                return (
                    <div className="flex flex-col space-y-4 w-full max-w-sm p-4 bg-white rounded-lg">
                        <div className="flex items-center space-x-2">
                            <div className="w-15 h-15 bg-blue-500 rounded-full flex items-center justify-center text-white font-bold">
                                <Image src="/assests/LOGOO.png" alt="sale" width={30} height={30} className=" items-center rounded-full" />
                            </div>
                            <div>
                        ...
                        <div className="space-y-4 text-black">
                            <div>
                                ...
                                <div className="flex items-center space-x-2 text-black">
                                    ...
                                    />
                                    <span className="text-gray-900">Avl Qty 100000</span>
                                </div>
                            </div>

                            <div>
                                <label className="block text-black text-sm mb-1">Quantity</label>
                                <div className="flex items-center space-x-2">
                                    <button
                            ...
                            <div>
                                <label className="block text-s ">Order Value</label>
                ...
                return (
                    <div className="flex flex-col space-y-4 w-full max-w-sm p-4 bg-white rounded-lg">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            />
                            <span class="text-gray-700">I accept the deal</span>
                        </div>
            ...
            case 2:
                return (
                    <div className="flex flex-col items-center space-y-4 w-full max-w-sm p-4 bg-white rounded-lg">
                        ...
                        <h2 className="text-xl font-semibold text-gray-700">Deal Sign Successfully</h2>
                        <button
                            onClick={() => setStep(3)}
                            className="w-full bg-green-500 text-white py-2 rounded-md"
                        >
                    ...
                    <div className="flex flex-col space-y-4 w-full max-w-sm p-4 bg-white rounded-lg">
                        <div className="flex items-center space-x-2">
                            ...
                            <div>
                                <div className="flex items-center space-x-2 text-gray-900">
                                    <span className="font-semibold">Trade Company</span>
                                    <span className=" text-sm">(56 AUD/UNR)</span>
                                    <span className="font-semibold">$21,000</span>
                                </div>
